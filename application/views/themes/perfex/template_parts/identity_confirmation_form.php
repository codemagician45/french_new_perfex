...
<div class="modal fade" tabindex="-1" role="dialog" id="identityConfirmationModal">
 <div class="modal-dialog" role="document">
  <div class="modal-content">
   ...
   <!-- <?php echo form_open((isset($formAction) ? $formAction : base_url('estimate/universign_get_url/'.$estimate->id.'/'.$estimate->hash)), array('id'=>'identityConfirmationForm','class'=>'form-horizontal')); ?> -->
  <form action="<?php echo base_url('estimate/universign_get_url/'.$estimate->id.'/'.$estimate->hash) ?>" id="identityConfirmationForm" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate" enctype="multipart/form-data">
...
<div class="form-group">
  <label for="document" class="control-label col-sm-2">
    <span class="text-left inline-block full-width">
      <?php echo _l('document'); ?>
    </span>
  </label>
  <div class="col-sm-10">
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <label class="switch">
      <input type="checkbox"  id="box" name="hand">       
...
<input type="hidden" id="profile" name="profile" value="default"/>
<!-- <p class="bold" id="signatureLabel"><?php echo _l('signature'); ?></p>
<div class="signature-pad--body">
  <canvas id="signature" height="130" width="550"></canvas>
</div> -->
<div id="signatureRemove">
...
<div class="modal-footer">
 ...
 <button type="submit" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off" data-form="#identityConfirmationForm" class="btn btn-success"><?php echo _l('next'); ?></button>
</div>
<?php echo form_close(); ?>
</div>
<!-- /.modal-content -->
...
<script>
  ...
  $(document).ready(function(){
    ...
    // $("#redirectTo").val('/'+res[1]+'/'+res[2]);
    $("#redirectTo").val(document.location.pathname);

    $('#identityConfirmationForm').submit(function(e) {
       // e.preventDefault();
       $('#signatureRemove').remove();
     });
  });
